...
namespace DCS.DCSTables
{
	...
	public partial class tblUDFBDBLOCK : SQLiteTable
	{
		
		#region Static SQL String Memebers
		/// <remarks>This _databasename represents the full INSERT INTO string for the table tblUDFBDBLOCK.</remarks>
		internal static string SQL_Insert = @"INSERT INTO [tblUDFBDBLOCK] ([UDFunctionID], [FunctionID], [FunctionName], [VarpouID], [VarNameID], [PinName], [VarType], [InstanceName], [Type], [X], [Y], [NoOfExtensiblePins], [Page], [ISObject], [IsExtendedProperty], [ExtendedPropertyTXT]) VALUES(@UDFunctionID, @FunctionID, @FunctionName, @VarpouID, @VarNameID, @PinName, @VarType, @InstanceName, @Type, @X, @Y, @NoOfExtensiblePins, @Page, @ISObject, @IsExtendedProperty, @ExtendedPropertyTXT) ; select last_insert_rowid(); ";
		
		/// <remarks>This _databasename represents the full UPDATE string for the table tblUDFBDBLOCK, with the WHERE clause.</remarks>
		internal static string SQL_Update = @"UPDATE [tblUDFBDBLOCK] SET [UDFunctionID] = @UDFunctionID, [FunctionID] = @FunctionID, [FunctionName] = @FunctionName, [VarpouID] = @VarpouID, [VarNameID] = @VarNameID, [PinName] = @PinName, [VarType] = @VarType, [InstanceName] = @InstanceName, [Type] = @Type, [X] = @X, [Y] = @Y, [NoOfExtensiblePins] = @NoOfExtensiblePins, [Page] = @Page, [ISObject] = @ISObject, [IsExtendedProperty] = @IsExtendedProperty, [ExtendedPropertyTXT] = @ExtendedPropertyTXT WHERE [FBDBlockID]=@FBDBlockID ";
		
		/// <remarks>This _databasename represents the full SELECT string for the table tblUDFBDBLOCK, with the WHERE clause.</remarks>
		internal static string SQL_Select = @"SELECT [UDFunctionID], [FunctionID], [FunctionName], [VarpouID], [VarNameID], [PinName], [VarType], [InstanceName], [Type], [X], [Y], [NoOfExtensiblePins], [Page], [ISObject], [IsExtendedProperty], [ExtendedPropertyTXT] FROM [tblUDFBDBLOCK] WHERE [FBDBlockID]=@FBDBlockID ";
		
		/// <remarks>This _databasename represents the DELETE string for the table tblUDFBDBLOCK, with the WHERE clause.</remarks>
		internal static string SQL_Delete = "DELETE FROM [tblUDFBDBLOCK] WHERE [FBDBlockID]=@FBDBlockID ";
		#endregion
		...
		public int Delete()
		{
			try
			{
				...
				Com.CommandText = tblUDFBDBLOCK.SQL_Delete;
		...
		public int Select()
		{
			try
			{
				...
				SQLiteCommand Com = Common.Conn.CreateCommand();
				Com.CommandText = tblUDFBDBLOCK.SQL_Select;
				Com.Parameters.AddRange(GetSqlParameters());
		...
		public int Insert()
		{
			try
			{
				...
				SQLiteCommand Com = Common.Conn.CreateCommand();
				Com.CommandText = tblUDFBDBLOCK.SQL_Insert;
				Com.Parameters.AddRange(GetSqlParameters());
		...
		public int Update()
		{
			try
			{
				...
				SQLiteCommand Com = Common.Conn.CreateCommand();
				Com.CommandText = tblUDFBDBLOCK.SQL_Update;
				Com.Parameters.AddRange(GetSqlParameters());
				int rowseffected = Com.ExecuteNonQuery();
				Com.Dispose();
	...
	public delegate void tblUDFBDBLOCKChangedEventHandler(object sender, System.EventArgs e);
	
	public partial class tblUDFBDBLOCKCollection : SQLiteTableCollection
	{
		
		/// <remarks>SQL Type:tblUDFBDBLOCKChangedEventHandler</remarks>
		public event tblUDFBDBLOCKChangedEventHandler tblUDFBDBLOCKChanged;
		...
		protected virtual void OntblUDFBDBLOCKChanged(System.EventArgs e)
		{
			if (tblUDFBDBLOCKChanged != null)
			{
				this.tblUDFBDBLOCKChanged(this, e);
			}
		}
		
		[Description("Gets a  tblUDFBDBLOCK from the collection.")]
		public tblUDFBDBLOCK this[int index]
		{
			get
			{
				return ((tblUDFBDBLOCK)(List[index]));
			}
			set
			{
				List[index] = value;
		...
		[Description("Gets a  tblUDFBDBLOCK from the collection.")]
		public tblUDFBDBLOCK Get(int index)
		{
			return ((tblUDFBDBLOCK)(List[index]));
		}
		
		[Description("Adds a new tblUDFBDBLOCK to the collection.")]
		...
		[Description("Removes a tblUDFBDBLOCK from the collection.")]
		...
		[Description("Inserts an tblUDFBDBLOCK into the collection at the specified index.")]
		...
		[Description("Returns the index value of the tblUDFBDBLOCK class in the collection.")]
		public int IndexOf(tblUDFBDBLOCK item)
		{
			return List.IndexOf(item);
		}
		
		[Description("Returns true if the tblUDFBDBLOCK class is present in the collection.")]
