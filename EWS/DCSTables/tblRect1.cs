...
namespace DCSTables
{
	...
	public partial class tblRect1 : Object
	{
		
		#region Static SQL String Memebers
		/// <remarks>This _databasename represents the full INSERT INTO string for the table tblRect1.</remarks>
		internal static string SQL_Insert = @"INSERT INTO [tblRect1] ([DisplayID], [oIndex], [bBrush], [bPen], [LogpenLopnColor], [LogpenLopnStyle], [LogpenLopnWidthX], [LogpenLopnWidthY], [LogbrushLbColor], [LogbrushLbHatch], [LogbrushLbStyle], [Left], [Top], [Right], [Bottom]) VALUES(@DisplayID, @oIndex, @bBrush, @bPen, @LogpenLopnColor, @LogpenLopnStyle, @LogpenLopnWidthX, @LogpenLopnWidthY, @LogbrushLbColor, @LogbrushLbHatch, @LogbrushLbStyle, @Left, @Top, @Right, @Bottom) ; select last_insert_rowid(); ";
		
		/// <remarks>This _databasename represents the full UPDATE string for the table tblRect1, with the WHERE clause.</remarks>
		internal static string SQL_Update = @"UPDATE [tblRect1] SET [DisplayID] = @DisplayID, [oIndex] = @oIndex, [bBrush] = @bBrush, [bPen] = @bPen, [LogpenLopnColor] = @LogpenLopnColor, [LogpenLopnStyle] = @LogpenLopnStyle, [LogpenLopnWidthX] = @LogpenLopnWidthX, [LogpenLopnWidthY] = @LogpenLopnWidthY, [LogbrushLbColor] = @LogbrushLbColor, [LogbrushLbHatch] = @LogbrushLbHatch, [LogbrushLbStyle] = @LogbrushLbStyle, [Left] = @Left, [Top] = @Top, [Right] = @Right, [Bottom] = @Bottom WHERE [RectID]=@RectID ";
		
		/// <remarks>This _databasename represents the full SELECT string for the table tblRect1, with the WHERE clause.</remarks>
		internal static string SQL_Select = "SELECT [DisplayID], [oIndex], [bBrush], [bPen], [LogpenLopnColor], [LogpenLopnSty" +
			"le], [LogpenLopnWidthX], [LogpenLopnWidthY], [LogbrushLbColor], [LogbrushLbHatch" +
			"], [LogbrushLbStyle], [Left], [Top], [Right], [Bottom] FROM [tblRect1] WHERE [Re" +
			"ctID]=@RectID ";
		
		/// <remarks>This _databasename represents the DELETE string for the table tblRect1, with the WHERE clause.</remarks>
		internal static string SQL_Delete = "DELETE FROM [tblRect1] WHERE [RectID]=@RectID ";
		#endregion
		
		#region Tables Memebers
		/// <remarks>SQL Type:System.Int64</remarks>
		private long _RectID;
		...
		public int Delete()
		{
			try
			{
				...
				Com.CommandText = tblRect1.SQL_Delete;
		...
		public void Select()
		{
			try
			{
				SQLiteConnection Conn = new SQLiteConnection(Common.ConnectionString);
				SQLiteCommand Com = Conn.CreateCommand();
				Com.CommandText = tblRect1.SQL_Select;
				Com.Parameters.AddRange(GetSqlParameters());
				Conn.Open();
		...
		public int Insert()
		{
			try
			{
				SQLiteConnection Conn = new SQLiteConnection(Common.ConnectionString);
				SQLiteCommand Com = Conn.CreateCommand();
				Com.CommandText = tblRect1.SQL_Insert;
				Com.Parameters.AddRange(GetSqlParameters());
				Conn.Open();
		...
		public int Update()
		{
			try
			{
				SQLiteConnection Conn = new SQLiteConnection(Common.ConnectionString);
				SQLiteCommand Com = Conn.CreateCommand();
				Com.CommandText = tblRect1.SQL_Update;
				Com.Parameters.AddRange(GetSqlParameters());
				Conn.Open();
				int rowseffected = Com.ExecuteNonQuery();
				Conn.Close();
	...
	public delegate void tblRect1ChangedEventHandler(object sender, System.EventArgs e);
	
	public partial class tblRect1Collection : System.Collections.CollectionBase
	{
		
		/// <remarks>SQL Type:tblRect1ChangedEventHandler</remarks>
		public event tblRect1ChangedEventHandler tblRect1Changed;
		...
		protected virtual void OntblRect1Changed(System.EventArgs e)
		{
			if (tblRect1Changed != null)
			{
				this.tblRect1Changed(this, e);
			}
		}
		
		[Description("Gets a  tblRect1 from the collection.")]
		public tblRect1 this[int index]
		{
			get
			{
				return ((tblRect1)(List[index]));
			}
			set
			{
				List[index] = value;
				this.OntblRect1Changed(EventArgs.Empty);
			}
		}
		
		[Description("Gets a  tblRect1 from the collection.")]
		public tblRect1 Get(int index)
		{
			return ((tblRect1)(List[index]));
		}
		
		[Description("Adds a new tblRect1 to the collection.")]
		public int Add(tblRect1 item)
		{
		...
		[Description("Removes a tblRect1 from the collection.")]
		public void Remove(tblRect1 item)
		{
			List.Remove(item);
			this.OntblRect1Changed(EventArgs.Empty);
		}
		
		[Description("Inserts an tblRect1 into the collection at the specified index.")]
		public void Insert(int index, tblRect1 item)
		{
			List.Insert(index, item);
			this.OntblRect1Changed(EventArgs.Empty);
		}
		
		[Description("Returns the index value of the tblRect1 class in the collection.")]
		public int IndexOf(tblRect1 item)
		{
			return List.IndexOf(item);
		}
		
		[Description("Returns true if the tblRect1 class is present in the collection.")]
		public bool Contains(tblRect1 item)
		{
