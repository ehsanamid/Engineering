...
namespace DCS.DCSTables
{
    ...
    public partial class tblFBDPinConnection : SQLiteTable
	{
		
		#region Static SQL String Memebers
		/// <remarks>This _databasename represents the full INSERT INTO string for the table tblFBDPinConnection.</remarks>
		internal static string SQL_Insert = @"INSERT INTO [tblFBDPinConnection] ([pouID], [RightObjectID], [LeftObjectID], [RightPinNo], [LeftPinNo], [RightPinName], [LeftPinName], [autodraw], [Page], [X0], [Y0], [X1], [Y1], [X2], [Y2], [X3], [Y3], [X4], [Y4], [X5], [Y5]) VALUES(@pouID, @RightObjectID, @LeftObjectID, @RightPinNo, @LeftPinNo, @RightPinName, @LeftPinName, @autodraw, @Page, @X0, @Y0, @X1, @Y1, @X2, @Y2, @X3, @Y3, @X4, @Y4, @X5, @Y5) ; select last_insert_rowid(); ";
		
		/// <remarks>This _databasename represents the full UPDATE string for the table tblFBDPinConnection, with the WHERE clause.</remarks>
		internal static string SQL_Update = @"UPDATE [tblFBDPinConnection] SET [pouID] = @pouID, [RightObjectID] = @RightObjectID, [LeftObjectID] = @LeftObjectID, [RightPinNo] = @RightPinNo, [LeftPinNo] = @LeftPinNo, [RightPinName] = @RightPinName, [LeftPinName] = @LeftPinName, [autodraw] = @autodraw, [Page] = @Page, [X0] = @X0, [Y0] = @Y0, [X1] = @X1, [Y1] = @Y1, [X2] = @X2, [Y2] = @Y2, [X3] = @X3, [Y3] = @Y3, [X4] = @X4, [Y4] = @Y4, [X5] = @X5, [Y5] = @Y5 WHERE [FBDPinConnectionID]=@FBDPinConnectionID ";
		
		/// <remarks>This _databasename represents the full SELECT string for the table tblFBDPinConnection, with the WHERE clause.</remarks>
		internal static string SQL_Select = @"SELECT [pouID], [RightObjectID], [LeftObjectID], [RightPinNo], [LeftPinNo], [RightPinName], [LeftPinName], [autodraw], [Page], [X0], [Y0], [X1], [Y1], [X2], [Y2], [X3], [Y3], [X4], [Y4], [X5], [Y5] FROM [tblFBDPinConnection] WHERE [FBDPinConnectionID]=@FBDPinConnectionID ";
		
		/// <remarks>This _databasename represents the DELETE string for the table tblFBDPinConnection, with the WHERE clause.</remarks>
		internal static string SQL_Delete = "DELETE FROM [tblFBDPinConnection] WHERE [FBDPinConnectionID]=@FBDPinConnectionID " +
			"";
		#endregion
		...
		public int Delete()
		{
			try
			{
				...
				Com.CommandText = tblFBDPinConnection.SQL_Delete;
		...
		public int Select()
		{
			try
			{
				...
				SQLiteCommand Com = Common.Conn.CreateCommand();
				Com.CommandText = tblFBDPinConnection.SQL_Select;
				Com.Parameters.AddRange(GetSqlParameters());
		...
		public int Insert()
		{
			try
			{
				...
				SQLiteCommand Com = Common.Conn.CreateCommand();
				Com.CommandText = tblFBDPinConnection.SQL_Insert;
				Com.Parameters.AddRange(GetSqlParameters());
		...
		public int Update()
		{
			try
			{
				...
				SQLiteCommand Com = Common.Conn.CreateCommand();
				Com.CommandText = tblFBDPinConnection.SQL_Update;
				Com.Parameters.AddRange(GetSqlParameters());
				int rowseffected = Com.ExecuteNonQuery();
				Com.Dispose();
	...
	public delegate void tblFBDPinConnectionChangedEventHandler(object sender, System.EventArgs e);
	
	public partial class tblFBDPinConnectionCollection : SQLiteTableCollection
	{
		
		/// <remarks>SQL Type:tblFBDPinConnectionChangedEventHandler</remarks>
		public event tblFBDPinConnectionChangedEventHandler tblFBDPinConnectionChanged;
		...
		protected virtual void OntblFBDPinConnectionChanged(System.EventArgs e)
		{
			if (tblFBDPinConnectionChanged != null)
			{
				this.tblFBDPinConnectionChanged(this, e);
			}
		}
		
		[Description("Gets a  tblFBDPinConnection from the collection.")]
		public tblFBDPinConnection this[int index]
		{
			get
			{
				return ((tblFBDPinConnection)(List[index]));
			}
			set
			{
				List[index] = value;
				this.OntblFBDPinConnectionChanged(EventArgs.Empty);
			}
		}
		
		[Description("Gets a  tblFBDPinConnection from the collection.")]
		public tblFBDPinConnection Get(int index)
		{
			return ((tblFBDPinConnection)(List[index]));
		}
		
		[Description("Adds a new tblFBDPinConnection to the collection.")]
		public void Add(tblFBDPinConnection item)
		{
			List.Add(item);
			this.OntblFBDPinConnectionChanged(EventArgs.Empty);
		}
		
		[Description("Removes a tblFBDPinConnection from the collection.")]
		public void Remove(tblFBDPinConnection item)
		{
			List.Remove(item);
			this.OntblFBDPinConnectionChanged(EventArgs.Empty);
		}
		
		[Description("Inserts an tblFBDPinConnection into the collection at the specified index.")]
		public void Insert(int index, tblFBDPinConnection item)
		{
			List.Insert(index, item);
			this.OntblFBDPinConnectionChanged(EventArgs.Empty);
		}
		
		[Description("Returns the index value of the tblFBDPinConnection class in the collection.")]
		public int IndexOf(tblFBDPinConnection item)
		{
			return List.IndexOf(item);
		}
		
		[Description("Returns true if the tblFBDPinConnection class is present in the collection.")]
		public bool Contains(tblFBDPinConnection item)
		{
