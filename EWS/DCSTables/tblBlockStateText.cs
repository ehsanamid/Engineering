...
namespace DCS.DCSTables
{
    ...
    public partial class tblBlockStateText : SQLiteTable
	{
		
		#region Static SQL String Memebers
		/// <remarks>This _databasename represents the full INSERT INTO string for the table tblBlockStateText.</remarks>
		internal static string SQL_Insert = "INSERT INTO [tblBlockStateText] ([SolitionID], [Txt], [Bit], [Decsription], [Read" +
			"only]) VALUES(@SolitionID, @Txt, @Bit, @Decsription, @Readonly) ; select last_in" +
			"sert_rowid(); ";
		
		/// <remarks>This _databasename represents the full UPDATE string for the table tblBlockStateText, with the WHERE clause.</remarks>
		internal static string SQL_Update = "UPDATE [tblBlockStateText] SET [SolitionID] = @SolitionID, [Txt] = @Txt, [Bit] = " +
			"@Bit, [Decsription] = @Decsription, [Readonly] = @Readonly WHERE [ID]=@ID ";
		
		/// <remarks>This _databasename represents the full SELECT string for the table tblBlockStateText, with the WHERE clause.</remarks>
		internal static string SQL_Select = "SELECT [SolitionID], [Txt], [Bit], [Decsription], [Readonly] FROM [tblBlockStateT" +
			"ext] WHERE [ID]=@ID ";
		
		/// <remarks>This _databasename represents the DELETE string for the table tblBlockStateText, with the WHERE clause.</remarks>
		internal static string SQL_Delete = "DELETE FROM [tblBlockStateText] WHERE [ID]=@ID ";
		#endregion
		...
		public int Delete()
		{
			try
			{
				...
				Com.CommandText = tblBlockStateText.SQL_Delete;
		...
		public int Select()
		{
			try
			{
				...
				SQLiteCommand Com = Common.Conn.CreateCommand();
				Com.CommandText = tblBlockStateText.SQL_Select;
				Com.Parameters.AddRange(GetSqlParameters());
		...
		public int Insert()
		{
			try
			{
				...
				SQLiteCommand Com = Common.Conn.CreateCommand();
				Com.CommandText = tblBlockStateText.SQL_Insert;
				Com.Parameters.AddRange(GetSqlParameters());
		...
		public int Update()
		{
			try
			{
				...
				SQLiteCommand Com = Common.Conn.CreateCommand();
				Com.CommandText = tblBlockStateText.SQL_Update;
				Com.Parameters.AddRange(GetSqlParameters());
				int rowseffected = Com.ExecuteNonQuery();
				Com.Dispose();
	...
	public delegate void tblBlockStateTextChangedEventHandler(object sender, System.EventArgs e);
	
	public partial class tblBlockStateTextCollection : SQLiteTableCollection
	{
		
		/// <remarks>SQL Type:tblBlockStateTextChangedEventHandler</remarks>
		public event tblBlockStateTextChangedEventHandler tblBlockStateTextChanged;
		...
		public tblBlockStateTextCollection(tblSolution _parent)
		{
			_SolutionID_tblSolution = _parent;
		}
		
		[Description("Invoke the Changed event; called whenever list changes")]
		protected virtual void OntblBlockStateTextChanged(System.EventArgs e)
		{
			if (tblBlockStateTextChanged != null)
			{
				this.tblBlockStateTextChanged(this, e);
			}
		}
		
		[Description("Gets a  tblBlockStateText from the collection.")]
		public tblBlockStateText this[int index]
		{
			get
			{
				return ((tblBlockStateText)(List[index]));
			}
			set
			{
				List[index] = value;
		...
		[Description("Gets a  tblBlockStateText from the collection.")]
		public tblBlockStateText Get(int index)
		{
			return ((tblBlockStateText)(List[index]));
		}
		
		[Description("Adds a new tblBlockStateText to the collection.")]
		...
		[Description("Removes a tblBlockStateText from the collection.")]
		...
		[Description("Inserts an tblBlockStateText into the collection at the specified index.")]
		...
		[Description("Returns the index value of the tblBlockStateText class in the collection.")]
		public int IndexOf(tblBlockStateText item)
		{
			return List.IndexOf(item);
		}
		
		[Description("Returns true if the tblBlockStateText class is present in the collection.")]
