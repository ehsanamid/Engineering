...
namespace DCS.DCSTables
{
	...
	public partial class tblPlantStructureObject 
	{
        public override bool PostDeleteTriger()
        {
            tblSolution.m_tblSolution().m_tblPlantStructureObjectCollection.Remove(this);
            tblSolution.m_tblSolution().PlantStructureObject.Remove(Type);
            return true;
        }
        ...
        public override bool PostInsertTriger()
        {
            ...
            tblSolution.m_tblSolution().m_tblPlantStructureObjectCollection.Add(this);
            tblSolution.m_tblSolution().PlantStructureObject.Add(Type, this);
            return true;
        }
	}
	
	public partial class tblPlantStructureObjectCollection 
	{
