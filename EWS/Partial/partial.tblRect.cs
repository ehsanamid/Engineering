...
namespace DCS.DCSTables
{
	...
	public partial class tblRect 
	{
        
	}
	
	
	public partial class tblRectCollection 
	{
        ...
        public bool RemoveFromTable()
        {
            try
            {
                ...
                Com.CommandText = @"DELETE FROM [tblRect] WHERE [DisplayID]= " + m_DisplayID_tblDisplay.DisplayID + ";";
