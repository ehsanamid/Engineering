...
namespace DCS.DCSTables
{
	...
	public partial class tblBitmapCollection 
	{
        ...
        public override bool Load()
        {
            ...
            try
            {
                ...
                myCommand.CommandText = @"SELECT * FROM [tblBitmap]  WHERE [DisplayID]= " + m_DisplayID_tblDisplay.DisplayID + " order by oIndex;";
                ...
                foreach (long id in idlist)// (int i = 0; i < count ; i++)
                {
                    ...
                    tblbitmap.ID = id;
                    tblbitmap.m_DisplayID_tblDisplay = this.m_DisplayID_tblDisplay;
                    tblbitmap.Select();
        ...
        public bool RemoveFromTable()
        {
            try
            {
                ...
                Com.CommandText = @"DELETE FROM [tblBitmap] WHERE [DisplayID]= " + m_DisplayID_tblDisplay.DisplayID + ";";
