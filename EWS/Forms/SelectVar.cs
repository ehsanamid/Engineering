...
using DCS.TagAutocomplete;

namespace DCS.Forms
{
    public partial class SelectVar : Form
    {
        ...
        public SelectVar()
        {
            ...
            advancedDataGridView_main.Columns.Add(dataGridViewColumn);

            dataGridViewColumn = new DataGridViewColumn();
            dataGridViewColumn.ValueType = typeof(string);
            dataGridViewColumn.Name = "Description";
            dataGridViewColumn.HeaderText = "Description";
            dataGridViewColumn.DataPropertyName = "Description";
            dataGridViewColumn.CellTemplate = dataGridViewCell;
            advancedDataGridView_main.Columns.Add(dataGridViewColumn);

            dataGridViewColumn = new DataGridViewColumn();
            dataGridViewColumn.ValueType = typeof(string);
            dataGridViewColumn.Name = "Type";
            dataGridViewColumn.HeaderText = "Type";
            dataGridViewColumn.DataPropertyName = "Type";
            dataGridViewColumn.CellTemplate = dataGridViewCell;
            advancedDataGridView_main.Columns.Add(dataGridViewColumn);
        ...
        private void advancedDataGridView_main_FilterStringChanged(object sender, EventArgs e)
        {
            try
            {
                //dataGridView1.FilterString = advancedDataGridView_main.FilterString;
        ...
        private void BindingSourceToGrid()
        {
            ...
            {
                //advancedDataGridView_main.Rows.Add(_dataTable.Rows[i]);
                DataRowView ss = (DataRowView)bindingSource_main.List[0];
                string ss1 = ss[0].ToString();
                ss1 = ss[1].ToString();
                ss1 = ss[2].ToString();
                ss1 = ss[3].ToString();
                //ss = (string)_dataTable.Rows[i].ItemArray[1];
                //ss = (string)_dataTable.Rows[i].ItemArray[2];
                //long ll = (long)_dataTable.Rows[i].ItemArray[3];
                string[] row = new string[] {  ((DataRowView)bindingSource_main.List[i])[0].ToString(),
                ...
                advancedDataGridView_main.Rows.Add(row);
            }
        }
        ...
        private void advancedDataGridView_main_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    //tblFunction tblfunction = tblSolution.m_tblSolution().m_tblFunctionCollection.GetFunctionbyType(tblvariable.Type);
        ...
        private void advancedDataGridView_main_RowHeaderMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
