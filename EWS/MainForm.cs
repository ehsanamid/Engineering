...
namespace DocToolkit.Forms
{
	...
	internal partial class MainForm : Form
	{
		...
		#region Members
        public TreeviewDisplayManager m_TreeviewDisplayManager = null;
		private DrawArea drawArea;
        //private System.Windows.Forms.TabControl tabcontrol;
		private DocManager docManager;
		private DragDropManager dragDropManager;
		private MruManager mruManager;
        public DCSProject m_Project = null;
		private string argumentFile = ""; // file name from command line
        
        public EWSTools.DCSProject.EWS_Status m_EWS_Status = EWSTools.DCSProject.EWS_Status.No_Project_Is_Loaded;
        public bool IsBeingOpened = false;
        public SqlConnection m_SqlConnectionGlobalConnection;
		...
		private void MainForm_Load(object sender, EventArgs e)
		{
            ...
            */
            ...
            drawArea.BackColor = System.Drawing.Color.Gainsboro;
            drawArea.Location = new System.Drawing.Point(4, 22);
            drawArea.Name = "tabPage1";
            drawArea.Padding = new System.Windows.Forms.Padding(3);
            drawArea.Size = new System.Drawing.Size(276, 165);
            drawArea.TabIndex = 0;
            drawArea.Text = "tabPage1";

            tabControl1.Controls.Add(drawArea);
		...
		/// Open new file
		/// </summary>
		private void CommandNewProject()
		{
            m_Project = new DCSProject(ref m_EWS_Status, ref IsBeingOpened,ref  m_SqlConnectionGlobalConnection);
    ...
    public void InitializeProjectTrees()
    {
        treeViewProject.Nodes.Add(m_Project.ProjectName);
        m_TreeviewDisplayManager = new TreeviewDisplayManager(ref treeViewDisplay, m_Project.ProjectName);
        //m_TreeviewDisplayManager.Init(m_Project.ProjectName);
        m_TreeviewDisplayManager.AddRoot(m_Project.ProjectName, 0, contextMenuStripDisplayMenu);
        //treeViewDisplay.Nodes.Add(m_Project.ProjectName);
        treeViewUser.Nodes.Add(m_Project.ProjectName);
        treeViewReport.Nodes.Add(m_Project.ProjectName);
        treeViewBlock.Nodes.Add(m_Project.ProjectName);
        treeViewLogic.Nodes.Add(m_Project.ProjectName);
        propertyGridComponemt.SelectedObject = (object)drawArea;
    }
