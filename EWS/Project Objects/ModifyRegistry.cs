...
namespace Utility.ModifyRegistry
{
	...
	public class ModifyRegistry
	{
        ...
        private string subKey = "SOFTWARE\\EEWS\\Setting";
		/// <summary>
        ...
        /// output: value (string) 
        /// </summary>
        public long ReadWord(string KeyName)
        {
        ...
        public bool ReadBool(string KeyName)
        {
            ...
            else
            {
                try
                {
                    // If the RegistryKey exists I get its value
                    // or null is returned.
                    i1 = (int)sk1.GetValue(KeyName.ToUpper());
        ...
        /// <summary>
		/// To write into a registry key.
		/// input: KeyName (string) , Value (Long)
		/// output: true or false 
		/// </summary>
        public bool WriteWord(string KeyName, object Value)
		{
			try
			{
				// Setting
        ...
        public bool WriteBool(string KeyName, bool Value)
        {
            try
            {
                ...
                sk1.SetValue(KeyName.ToUpper(), l, RegistryValueKind.DWord);
        ...
        /// output: true or false 
        /// </summary>
        public bool WriteString(string KeyName, object Value)
        {
            try
            {
                // Setting
