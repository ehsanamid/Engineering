...
namespace EWS
{
    ...
    public class Common
    {
        ...
        public static bool convertType2StringHeader<T>(T obj, StreamWriter writer)
        {
        ...
        public static string GetType2StringHeader<T>(T obj, string firstcoumn, string _exclude = "")
        {
            ...
            foreach (var prop in obj.GetType().GetProperties())
            {
                if ((firstcoumn != prop.Name) && (_exclude != prop.Name))
                {
                    str += prop.Name;
                    str += ",";
                }
        ...
        public static bool convertType2String<T>(T obj, StreamWriter writer)
        {
            bool ret = true;
            string str = "";
            foreach (var prop in obj.GetType().GetProperties())
    ...
    //public class stringColumnItems
    //{
    //    public string Name;
    //    public bool selected;
    //    public stringColumnItems(string name, bool _selected)
    //    {
    //        Name = name;
    //        selected = _selected;
    //    }
    //    public stringColumnItems()
    //    {
    //        Name = "";
    //        selected = true;
    //    }
...
*/
    ...
    {
        public long Index;//Index of variable
        //public int Nodeno;// controller node no
