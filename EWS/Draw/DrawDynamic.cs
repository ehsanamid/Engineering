...
namespace DocToolkit
{
	...
	/// </summary>
	[Serializable]
	public class DrawDynamic : DrawObject
	{
		...
		public override DrawObject Clone()
		{
            ...
            drawdynamic.rectangle = rectangle;

            FillDrawObjectFields(drawdynamic);
            return drawdynamic;
		}
		...
		public DrawDynamic()
		{
            ...
            Resizeable = false;
            SetRectangle(0, 0, ToolDynamic.DeltaY, ToolDynamic.DeltaX);
		}

		public DrawDynamic(int x, int y, int width, int height)
		{
		...
		public DrawDynamic(int x, int y, int width, int height, Color lineColor, Color fillColor)
		{
		...
		public DrawDynamic(int x, int y, int width, int height, Color lineColor, Color fillColor, bool filled)
		{
        ...
        public DrawDynamic(int x, int y, int width, int height, Color lineColor, Color fillColor, bool filled, int lineWidth)
		{
		...
		public override int HandleCount
		{
			get 
            {
                return 4 + 1 + _tblFunction.tblPinCollection.Count; 
            }
		}
		/// <summary>
		...
		public override Point GetHandle(int handleNumber)
		{
			...
			switch (handleNumber)
			{
                ...
                default:
                    ...
                    {
                        x = rectangle.X;
                        y = rectangle.Y + MainForm.UnitSize * MainForm.BaseSize * (handleNumber - 2) / 2;
                    }
                    else
                    {
                        if (handleNumber == ConnectionCount)
                        {
                            x = rectangle.Right;
                            y = rectangle.Y + MainForm.UnitSize * MainForm.BaseSize * (2 * ConnectionCount - 9) / 2;
                        }
                        else
                        {
