...
namespace DocToolkit
{
  ...
  /// </summary>
  internal partial class FBDDrawArea : System.Windows.Forms.TabPage
  //internal partial class DrawArea : UserControl
  {
    ...
    /// Active drawing tool.
    /// </summary>
    public FBDDrawToolType ActiveTool
    {
    ...
    /// <param name="e"></param>
    private void FBDDrawArea_Paint(object sender, PaintEventArgs e)
    {
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    private void FBDDrawArea_MouseDown(object sender, MouseEventArgs e)
    {
           ...
           MouseButtons.Right)
      {
        if (_panning)
          _panning = false;
        if (activeTool == FBDDrawToolType.PolyLine || activeTool == FBDDrawToolType.Connector)
          tools[(int)activeTool].OnMouseDown(this, e);
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    private void FBDDrawArea_MouseMove(object sender, MouseEventArgs e)
    {
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    private void FBDDrawArea_MouseUp(object sender, MouseEventArgs e)
    {
      //lastPoint = BackTrackMouse(e.Location);
      if (e.Button ==
        MouseButtons.Left)
